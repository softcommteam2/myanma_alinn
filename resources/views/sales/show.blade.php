...
<body class="">
    ...
    <div class="app-body" style="width:1500px;">
        <main class="main">
            <a class="btn btn-sm  btn-info float-right mr-1 d-print-none print" href="#"
                        ...
                        <div class="row print-container">
                            <div class="col-sm-4" style="border-right:1px solid;">
                                    ...
                                    <div class="col-sm-12">
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="pull-right rounded border border-dark" id="stamp"
                                                        style="transform: rotateY(0deg) rotate(45deg); text-align:center;">
                                                        Customer Copy</div>
                                                </td>
                                            </tr>
                                        </table>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <strong>ဘောက်ချာ : {{ $sales->item->itemsku->name }} -
                                            {{ $sales->sale_voucher_sku_id }}</strong>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <strong>{{ $sales->item->category->name }}
                                            ({{ number_format($sales->item->price) }}) ကျပ်</strong>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-sm-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <strong>({{ $sales->inches }}) Inches x ({{ $sales->columns }})
                                            Column</strong>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row"
                                    style="margin: 50px; border:1px solid; padding-left:10px; margin-left:0px;">
                                    ...
                                    <div class="col-sm-12">
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="pull-right p-1 rounded border border-dark"
                                                        id="stamp"
                                                        style="transform: rotateY(0deg) rotate(45deg); text-align:center;">
                                    ...
                                    <div class="col-sm-12">
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="pull-right rounded border border-dark" id="stamp"
                                                        style="transform: rotateY(0deg) rotate(45deg); text-align:center; margin-right:15px;">
                                                        <strong>Finance Copy</strong>
                                                    </div>
                                                </td>
                                            </tr>
                                        </table>
