                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 col-xl-6">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <input type="hidden" name="sale_voucher" id="sale_voucher"
                                                                class="input-group border border-info rounded form-control">
                                                            <input type="hidden" name="budget_year" id="budget_year"
                                                                class="input-group border border-info rounded form-control">
                                                            <input type="hidden" name="sale_voucher_sku"
                                                                id="sale_voucher_sku"
                                                                class="input-group border border-info rounded form-control"
                                                                value="{{ session()->get('sale_voucher_sku') }}">
                                                            ...
                                                            <fieldset class="form-group" id="myForm">
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-6 mt-1">
                                                                        ...
                                                                        <div class="input-group border border-info rounded">
                                                                            <input type="text" class="form-control"
                                                                                name="township" id="township" readonly
                                                                                value="{{ session()->get('township') }}">
                                                                        </div>
                                                                    </div>
                                                                    <div class="col-6 mt-1">
                                                            ...
                                                            <fieldset class="form-group">
                                                                <div class="row">
                                                                    <div class="col-lg-4 col-md-4 col-sm-12 mt-1">
                                                                        ...
                                                                        <div
                                                                            class="input-group border border-info rounded">
                                                                            <input type="text" class="form-control"
                                                                                name="record_date" readonly
                                                                                value="<?= $current_date->format('Y-m-d h:i') ?>">
                                                                    ...
                                                                    <div class="col-lg-4 col-md-4 col-sm-12 mt-1">
                                                                        ...
                                                                        <div
                                                                            class="input-group border border-info rounded">
                                                                            <input type="datetime-local"
                                                                                class="form-control" name="specified_date"
                                                                                value="<?= $current_date->format('Y-m-d h:i') ?>"
                                                                                required>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <fieldset class="form-group">
                                                                <div class="row">
                                                                    <div class="col-12 mt-1">
                                                                        ...
                                                                        <textarea name="description" required class="input-group border border-info rounded form-control" cols="30"
                                                                            rows="3">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col">
                                                                        ...
                                                                        <div
                                                                            class="input-group border border-info rounded">
                                                                            <select
                                                                                class="form-control mw-100 text-gray-700"
                                                                                id="paid_id" name="paid_id" required>
                                                                                <option selected value="">Choose
                                                                                    Account</option>
                                                                                @foreach ($accounts as $account)
                                                                                    <option value="{{ $account->id }}"
                                                                                        @if (session()->get('paid_id') == $account->id) selected @endif>
                                                                                        {{ $account->name }}</option>
                                                                                @endforeach
                                                                            </select>
                                                                        </div>
                                                                    ...
                                                                    <div class="col-lg-6 col-md-6 col-sm-12 mt-1">
                                                                        ...
                                                                        <textarea name="payment_comment" id="" class="input-group border border-info rounded form-control"
                                                                            cols="30" rows="1.5">
@if (session()->has('payment_comment'))
{{ session()->get('payment_comments') }}
@endif
</textarea>
                                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row">
                                                                <div class="col">
                                                                    ...
                                                                    <div class="input-group border border-info rounded">
                                                                        <select class="form-control mw-100 text-gray-700"
                                                                            id="item" name="item_id" required>
                                                                            <option selected value="">Choose Item
                                                                            </option>
                                                                            @foreach ($items as $item)
                                                                                <option
                                                                                    data-itemsku="{{ $item->itemsku_id }}"
                                                                                    data-price="{{ $item->price }}"
                                                                                    value="{{ $item->id }}"
                                                                                    @if (session()->get('item_id') == $item->itemsku_id) selected @endif>
                                                                                    {{ $item->name }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col mt-1">
                                                                    ...
                                                                    <input type="number" step=".01" id="inches"
                                                                        oninput="validate(this)" required name="inches"
                                                                        value="{{ session()->get('inches') }}"
                                                                        onkeyup="qty()"
                                                                        class="input-group border border-info rounded form-control">
                                                                </div>
                                                                <div class="col mt-1">
                                                                    ...
                                                                    <input type="number" id="columns" required
                                                                        name="columns" onkeyup="qty()"
                                                                        value="{{ session()->get('columns') }}"
                                                                        class="input-group border border-info rounded form-control">
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col mt-1">
                                                                    ...
                                                                    <input type="number" id="quantity" readonly required
                                                                        name="quantity"
                                                                ...
                                                                <div class="col mt-1">
                                                                    ...
                                                                    <input type="number" readonly required name="price"
                                                                        id="price" onkeyup="totpri()"
                                                                        value="{{ session()->get('price') }}"
                                                                        class="price input-group border border-info rounded form-control">
                                                                    <input type="text" hidden name="itemsku"
                                                                        id="itemsku_id"
                                                                        class="input-group border border-info rounded form-control"
                                                                        value="{{ session()->get('itemsku') }}">
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col mt-1">
                                                                    <strong class="h6">Amount</strong>
                                                                    <input type="number" step=".01" readonly required
                                                            ...
                                                            <div class="row">
                                                                <div class="col mt-1">
                                                                    <strong class="h6">Times (No.of days
                                                                        displayed)</strong>
                                                                    <input type="number" required name="times"
                                                                        id="times"
                                                                        class="input-group border border-info rounded form-control"
                                                                        value="1">
                                                                </div>
                                                                <div class="col mt-1">
                                                                    ...
                                                                    <input type="number" step=".01" readonly required
                                                                        name="timeprice" onkeyup="totpricetimes()"
                                                                        value="{{ session()->get('timeprice') }}"
                                                                        id="timeprice"
                                                                        class="input-group border border-info rounded form-control">
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col mt-1">
                                                                    ...
                                                                    <input type="number" step=".01" required
                                                                        ...
                                                                        id="discount_amount" onkeyup="totamt()"
                                                                        class="input-group border border-info rounded form-control">
                                                                </div>
                                                            </div>
                                                            <div class="row">
                                                                <div class="col mt-1">
                                                                    ...
                                                                    <input type="hidden" step="0.01" required
                                                                        name="total_amount"
                                                                        value="{{ session()->get('total_amount') }}"
                                                                        id="total_amount"
                                                                        class="input-group border border-info rounded form-control number-separator">
                                                                    <input readonly type="text" step="0.01"
                                                                        onchange="return onlyNumberKey(event)"
                                                                        id="displaytot"
                                                                        class="input-group border border-info rounded form-control">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-12 col-md-12 col-sm-12 mt-1">
                                                                    ...
                                                                    <textarea name="comments" id="" class="input-group border border-info rounded form-control" cols="30"
                                                                        rows="3">
        ...
        document.forms['saleForm'].onsubmit = function() {
            ...
            if (current_date < budget_yr_change_date) {
                current_budget_year = current_year -
                    1 // March ma kyaw thy buu so , budegt year ko a yin year u Example, if current year is 2022 , but march la ma kyaw thy buu so 2021 loc u
            } else if (current_date > budget_yr_change_date) {
                current_budget_year = current_year
            }

            @php
                $final_year = DB::table('sales')
                    ->latest('id')
                    ->first();
                // dd($final_year);
                if ($final_year == null) {
                ...
                $budget_year = DB::table('sales')
                    ->where('budget_year', $current_budget_year_final)
                    ->count();
                // dd($budget_year); // 1
            @endphp
            let id = {{ $budget_year }};
