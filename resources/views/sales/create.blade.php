                                                                ...
                                                                <div class="col mt-1">
                                                                    ...
                                                                    <div class="input-group border border-info rounded" id="cusdrop">
                                                                        <select class="customer form-control" data-live-search="true" id="customer" name="customer_id" required style="padding:30px 0">
                                                                            ...
                                                                            <option value="{{ $customer->id }}" @if (session()->get('customer_id') == $customer->id) selected @endif>
                                                                                {{ $customer->name }}
                                                                            </option>
                                                                            @endforeach
                                                                        </select>
                                                        ...
                                                        <fieldset class="form-group">
                                                            <div class="row">
                                                                <div class="col-12 mt-1">
                                                                    ...
                                                                    <textarea name="description" required class="input-group border border-info rounded form-control" cols="30" rows="3">
                                                        ...
                                                        <fieldset class="form-group">
                                                            <div class="row">
                                                                <div class="col">
                                                                    ...
                                                                    <div class="input-group border border-info rounded">
                                                                        <select class="form-control mw-100 text-gray-700" id="paid_id" name="paid_id" required>
                                                                            ...
                                                                            <option value="{{ $account->id }}" @if (session()->get('paid_id') == $account->id) selected @endif>
                                                                                {{ $account->name }}
                                                                            </option>
                                                                            @endforeach
                                                                        </select>
                                                                ...
                                                                <div class="col-lg-6 col-md-6 col-sm-12 mt-1">
                                                                    ...
                                                                    <textarea name="payment_comment" id="" class="input-group border border-info rounded form-control" cols="30" rows="1.5">
                                                    ...
                                                    <div class="card-body">
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <div class="input-group border border-info rounded">
                                                                    <select class="form-control mw-100 text-gray-700" id="item" name="item_id" required>
                                                                        ...
                                                                        <option data-itemsku="{{ $item->itemsku_id }}" data-price="{{ $item->price }}" value="{{ $item->id }}" @if (session()->get('item_id') == $item->itemsku_id) selected @endif>
                                                                            {{ $item->name }}
                                                                        </option>
                                                                        @endforeach
                                                                    </select>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-12 col-md-12 col-sm-12 mt-1">
                                                                ...
                                                                <textarea name="comments" id="" class="input-group border border-info rounded form-control" cols="30" rows="3">
...
<script>
    document.forms['saleForm'].onsubmit = function() {
        ...
        if (budget_year == 0) {
            // alert('0')
            id = 1;
        } else if (current_budget_year != {
                {
                    $current_budget_year_final
                }
            })
            (
                id = 1
