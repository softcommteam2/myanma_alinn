                ...
                <div class="card-body" x-data="calc()">
                    <fieldset class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col">{{ $sales->item->itemsku->name }} - {{$sales->sale_voucher_sku_id}}</div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-8">
                                ...
                                <div class="input-group border border-info rounded">
                                    <input type="text" readonly class="form-control" id="record_date" name="record_date" required value="{{ $sales->record_date->format('Y-m-d') }}" >
                                    <input type="text" hidden class="form-control" required value="1" name="change_date_status" >
                                    <input type="text" hidden class="form-control" required value="{{ $sales->change_date_status }}">

                                </div>
                            </div>
                                <div class="col mt-4">
                                    @if ($sales->change_date_status == 0)
                                        <label for="" class="btn btn-info outline" onclick="previousDay()">Previous Day</label>
                                        <label for="" class="btn btn-info outline" onclick="nextDay()" id="btn1" >Next Day</label>
                                    @else
