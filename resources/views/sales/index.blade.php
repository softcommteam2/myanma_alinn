                                        ...
                                        <table class="table table-striped table-bordered datatable mt-2" id="dataTable">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{ $sale->item->itemsku->name }} - {{$sale->sale_voucher_sku_id}}</td>
                                                        <td>{{ $sale->customer->name }}</td>
                                                        <td>{{ $sale->sale_date->format('d-m-Y H:i') }}</td>
                                                        <td >{{ $sale->account->name }}</td>
                                                        <td style="text-align: right">{{ number_format("$sale->timeprice", 2) }} </td>
                                                        ...
                                                        @if (Auth::user()->role->id == 3)
                                                                <td>
                                                                        ...
                                                                        <button data-toggle="tooltip" onclick="cash()" data-placement="top" title="Edit to Sales" class="btn btn-info disabled"><i class="fa fa-edit"></i></button>
                                                                        <button data-toggle="tooltip" onclick="cash()" data-placement="top" title="Delete to Sales" class="btn btn-danger disabled"><i class="fa fa-trash"></i></button>
                                                                </td>
                                                            @else
                                                            <td>
                                                                <form action="{{url('sales_cancel/'.$sale->id)}}" method="POST" >
                                                                    @csrf
                                                                ...
                                                                @if ($sale->cancel=="1")
                                                                <button id="myBtn" onclick="myFunction()" disabled  class="btn btn-danger" type="submit" name="cancel"><i class="fa fa-ban"></i></button>
                                                                @else
                                                                <button id="myBtn" onclick="myFunction()"   class="btn btn-danger" type="submit" name="cancel"><i class="fa fa-ban"></i></button>
                                                                @endif
                                                                </form>
                                                            </td>
                                                        @endif
