        ...
        <div class="animated fadeIn">
          <div class="card">
            <div class="card-header">
                <div class="text-primary" style="font-size: 20px">Account List</div>
              <div class="card-header-actions">
                <a href="{{ url('accounts') }}" class="btn btn-secondary">Refresh</a>
                <a class="card-header-action" href="{{ url('accounts/create') }}">
                  <small class="btn btn-success"><i class="fa fa-plus"></i></small>
                </a>
              </div>
            </div>
            <div class="card-body">
                <form action="{{ url('accounts_search') }}" method="GET">
                    @csrf
                    <div class="row">
                ...
                <table class="table table-striped table-bordered datatable">
                  <thead>
                      <tr>
                          ...
                          <th class="col-md-2" onclick="sortTable(1)">Account</th>
                  ...
                  <tbody>
                      ...
                      <form action="{{url('accounts/'.$account->id)}}" method="POST" >
                          ...
                          <tr>
                              ...
                              <td>
                                <a class="btn btn-info" href="{{url('accounts/'.$account->id.'/edit')}}" data-toggle="tooltip" data-placement="top" title="Edit to Customer" name="Edit">
