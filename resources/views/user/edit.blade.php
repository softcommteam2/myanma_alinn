                                            ...
                                            <form>
                                                ...
                                                <fieldset class="form-group">
                                                    ...
                                                    <div class="input-group border border-info rounded">
                                                        ...
                                                        <input class="form-control" id="date" required
                                                            name="name" type="text" value="{{ $users->name }}">
                                                    </div>
                                                </fieldset>
                                                @if ($users->role_id === '2')
                                                    <fieldset>
                                                        <div class="radio-toolbar">
                                                            <input type="radio" id="radioManager" name="role_id"
                                                                value="2" checked>
                                                            <label for="radioManager">Manager</label>

                                                            <input type="radio" id="radioCashier" name="role_id"
                                                                value="3">
                                                ...
                                                <fieldset class="form-group">
                                                    ...
                                                    <div class="input-group border border-info rounded">
                                                        ...
                                                        <input class="form-control" id="tin" type="email"
                                                            required value="{{ $users->email }}" name="email">
                                                    </div>
                                                </fieldset>
                                                <fieldset class="form-group">
                                                    ...
                                                    <div class="input-group border border-info rounded">
                                                        ...
                                                        <input class="form-control" id="ssn" type="password"
