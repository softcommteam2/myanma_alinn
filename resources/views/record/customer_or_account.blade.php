                                    ...
                                    <div class="card-header py-3 card-header-color">
                                        ...
                                        <div class=" float-right">
                                            ...
                                            <form action="{{ url('record/cusoracc_search') }}" method="GET">
                                                @csrf
                                                <div class="row">
                                                    <div name="searchbar" class="hide input-group border border-info rounded">
                                                        <input type="text" name="search" placeholder="Search here"class="form-control">
                                                        <span class="input-group-append">
                                                            <button class="hide btn btn-primary">Search</button>
                                                        </span>
                                                        <a href="{{ url('record/customer_or_account') }}" class="hide btn btn-secondary">Refresh</a>
                                                        @if (!empty($search))
                                                        <a class="pull-right m-1" href="#" onclick="window.print();return false;">
