                                    ...
                                    <select required class="form-control" id="category-dropdown" name="category_id">
                                        @foreach ($categories as $category)
                                            <option value="{{ $category->id }}"
                                                @if ($category->id == $items->category->id) selected @endif>{{ $category->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <input readonly class="form-control"  type="text" required value="{{ $items->itemsku->name }}" > --}}
                                    <select required class="form-control" id="category-dropdown" name="itemsku_id">
                                        @foreach ($itemsku as $sku)
                                            <option value="{{ $sku->id }}"
                                                @if ($sku->id == $items->itemsku->id) selected @endif>{{ $sku->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <fieldset class="form-group">
                                ...
                                <div class="input-group border border-info rounded">
                                    <input class="form-control" id="price" type="text" required
                                        value="{{ $items->price }}" name="price">
                                </div>
                            </fieldset>
                            <fieldset class="form-group">
                                <label>Cost Price</label>
                                <div class="input-group border border-info rounded">
                                    <input class="form-control" id="cost_price" type="text" required
                                        value="{{ $items->cost_price }}" name="cost_price">
                                </div>
                            </fieldset>
                            <fieldset class="form-group">
                                <label>Brand</label>
                                <div class="input-group border border-info rounded">
                                    <input class="form-control" id="brand" type="text" required
                                        value="{{ $items->brand }}" name="brand">
                                </div>
                            </fieldset>
                            <fieldset class="form-group">
                                <label>Item Stock Amount</label>
                                <div class="input-group border border-info rounded">
                                    <input class="form-control" id="stock_amount" type="text" required
                                        value="{{ $items->stock_amount }}" name="stock_amount">
                                </div>
                            </fieldset>
                            <fieldset class="form-group">
                                ...
                                <div class="input-group border border-info rounded">
                                    <input class="form-control" id="description" type="text" required
                                        value="{{ $items->description }}" name="description">
                                </div>
                            </fieldset>
                            <fieldset class="form-group">
                ...
                $('#category-dropdown').on('change', function() {
                    ...
                    $.ajax({
                        ...
                        success: function(result) {
                            console.log(result);
                            $('#itemsku-dropdown').html(
                                '<option value="{{ $items->itemsku->id }}">{{ $items->itemsku->name }}'
                                );
                            $.each(result, function(key, value) {

                                $("#itemsku-dropdown").append(
                                    '<option value="{{ $items->itemsku->id }}">{{ $items->itemsku->name }}</option>'
                                    );;
                            });
                        }
                    });
