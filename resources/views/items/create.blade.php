                                ...
                                <div class="card-body">
                                    <form>
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <div class="input-group border border-info rounded">
                                                <select required class="form-control" id="category-dropdown"
                                                    name="category_id">
                                        ...
                                        <fieldset class="form-group">
                                            ...
                                            <div class="input-group border border-info rounded">
                                                <select required class="form-control" id="itemsku-dropdown"
                                                    name="itemsku_id"></select>
                                            </div>
                                        </fieldset>
                                        <fieldset class="form-group">
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        ...
                        $.each(result, function(key, value) {
                            $("#itemsku-dropdown").append('<option value="' + value.id +
                                '">' + value.name + '</option>');
                        });
                    }
                });
