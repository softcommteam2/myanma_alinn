                                    ...
                                    <div class="card-header py-3 card-header-color">
                                        <div class="row">
                                            <div class="col float-left">
                                                <h1
                                                    class="text-2xl leading-6 font-medium text-gray-900 text-left pb-3 pl-2">
                                                    Sales List
                                                </h1>
                                            ...
                                            <div class="col">
                                                <form action="{{ url('timeframe/bymonth_search') }}" method="GET"
                                                    class="hidden">
                                                    @csrf
                                        ...
                                        <div class="col">
                                            <form method="POST" class="hidden">
                                                @csrf
                                                <a onclick="ExportToExcel('xlsx')"
                                                    class="btn btn-success pull-right m-1"><span
