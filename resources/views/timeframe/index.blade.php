...
<style>
    ...
    .dropdown-content a:hover {background-color: #0d7be2}
                ...
                <fieldset class="form-group" id="se_date" style="display:auto;">
                    <div class="row">
                        ...
                        <div class="col-3 mt-4">
                            ...
                            <a class="btn btn-info" href="#" onclick="window.print(); return false;"><i class="fa fa-print"></i></a>
                        </div>
                    </div>
                </fieldset>
                    ...
                    @csrf
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-12 mt-1">
                                <div class="dropdown">
                                <label for="Daily Report" class="form-control bg-warning text-dark dropbtn" style="text-align: center;appearance: none;">Daily Report</label>
                                <div class="dropdown-content">
                                    <a href="{{ url('timeframe/today') }}" class="btn btn-primary">Today</a>
                                    <a href="{{ url('timeframe/last3days') }}" class="btn btn-primary">Last 3 Days</a>
                                    <a href="{{ url('timeframe/last7days') }}" class="btn btn-primary">Last 7 Days</a>
                                    <a href="{{ url('timeframe/last10days') }}" class="btn btn-primary">Last 10 Days</a>
                                    <a href="{{ url('timeframe/last14days') }}" class="btn btn-primary">Last 14 Days</a>
                                </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12 mt-1">
                                <div class="dropdown">
                                    <label for="Weekly Report" class="form-control bg-warning text-dark dropbtn" style="text-align: center;appearance: none;">Weekly Report</label>
                                    <div class="dropdown-content">
                                        <a href="{{ url('timeframe/thisweek') }}" class="btn btn-primary">This Week</a>
                                    <a href="{{ url('timeframe/previousweek') }}" class="btn btn-primary">Previous Week</a>
                                    </div>
                                    </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12 mt-1">
                                <div class="dropdown">
                                    <label for="Monthly Report" class="form-control bg-warning text-dark dropbtn" style="text-align: center;appearance: none;">Monthly Report</label>
                                    <div class="dropdown-content">
                                        <a href="{{ url('timeframe/thismonth') }}" class="btn btn-primary">This Month</a>
                                        <a href="{{ url('timeframe/previousmonth') }}" class="btn btn-primary">Previous Month</a>
                                        <a href="{{ url('timeframe/bymonth') }}" class="btn btn-primary">Choose Month</a>
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-12 mt-1">
                                <div class="dropdown">
                                    <label for="Yearly Report" class="form-control bg-warning text-dark dropbtn" style="text-align: center;appearance: none;">Yearly Report</label>
                                    <div class="dropdown-content">
                                        <a href="{{ url('timeframe/thisyear') }}" class="btn btn-primary">This Year</a>
                                    </div>
                                </div>
                            </div>
                        </div>
