                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <form method="POST" class="hide">
                                            @csrf
                                            <a onclick="ExportToExcel('xlsx')" class="btn btn-success pull-right m-1"><span
                                                            ...
                                                            <div class="card-body">
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table table-striped table-bordered"
                                                                        id="tbl_exporttable" style="width:100%">
                                                                        <thead>
                                                                            <tr>
                                                                                <th>No.</th>
                                                                            ...
                                                                            @foreach ($sales as $sale)
                                                                                <form action="{{ url('sales/' . $sale->id) }}"
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>{{ $sale->sale_date->format('d-m-Y H:i') }}
                                                                                        </td>
                                                                                        <td>{{ $sale->customer->name }}</td>
                                                                                        <td>{{ $sale->account->name }}</td>
                                                                                        <td style="text-align: right">
                                                                                            {{ number_format($sale->timeprice) }}
                                                                                        </td>
                                                                                        <td style="text-align: right">
                                                                                        ...
                                                                                        @if ($sale->cancel == '1')
                                                                                            <td><span
                                                                                                    class="bg-warning rounded p-1">Cancelled</span>
                                                                                            </td>
                                                                                        @else
                                                                                            @if ($sale->status == '1')
                                                                                                <td><span
                                                                                                        class="bg-green rounded p-1">Active</span>
                                                                                                </td>
                                                                                            @else
                                                                                                <td><span
                                                                                                        class="bg-danger rounded p-1">Banned</span>
                                                                                                </td>
                                                                                            @endif
                                                                                        @endif
                                                                                    </tr>
