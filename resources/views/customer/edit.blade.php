                    ...
                    <div class="col-md-12">
                      <div class="card">
                        ...
                        <fieldset class="form-group">
                            ...
                            <input class="form-control" id="date" required name="name" type="text" value="{{ $customer->name }}">
                            </div>
                        </fieldset>
                        <fieldset class="form-group">
                            ...
                            <input class="form-control" id="phone" type="text" required name="phone" value="{{ $customer->phone }}">
                            </div>
                        </fieldset>
                        <fieldset class="form-group">
                            ...
                            <input class="form-control" id="tin" type="text" required name="township" value="{{ $customer->township }}">
                            </div>
                        </fieldset>
                        <fieldset class="form-group">
                            <label>City</label>
                            ...
                            <input class="form-control" id="ssn" type="text" required name="city" value="{{ $customer->city }}">
                            </div>
                        </fieldset>
                        <fieldset class="form-group">
                            <label>Address</label>
                            ...
                            <input class="form-control" id="eyescript" type="text" required name="address" value="{{ $customer->address }}">
                            </div>
