                                                ...
                                                <fieldset class="form-group">
                                                    ...
                                                    <div class="input-group border border-info rounded">
                                                        ...
                                                        <input required type="text" id="name" name="name"
                                                            class="form-control mw-100" value="{{ $itemsku->name }}" />
                                                    </div>
                                                </fieldset>
                                                <fieldset class="form-group">
                                                    ...
                                                    <div class="input-group border border-info rounded">
                                                        <select required class="form-control" id="category_id"
                                                            name="category_id">
                                                            <option value="{{ $itemsku->category->id }}" selected>
                                                                {{ $itemsku->category->name }}</option>
                                                            @foreach ($categories as $category)
                                                                <option value="{{ $category->id }}"
                                                                    @if ($category->id == $itemsku->category->id) selected @endif>
